      ...
      <div className="max-w-2xl text-center mx-auto">
        ...
        <div className="mt-5 max-w-2xl">
          <h1 className="block font-semibold text-gray-800 text-4xl md:text-5xl lg:text-6xl ">
            Make  Prediction Over <span className = " text-emerald-600">{s[0].toUpperCase()+ s.slice(1,s.length).toLowerCase()}</span>  Stock Market
          </h1>
        </div>
        

        <div className="mt-5 max-w-3xl">
          <p className="text-md md:text-lg text-black">Preline UI is an open-source set of prebuilt UI components, ready-to-use examples and Figma design system based on the utility-first Tailwind CSS framework.</p>
        </div>
